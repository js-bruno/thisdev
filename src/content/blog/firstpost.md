...
depois de muita luta consegui finalizar o deploy dele para minha vps de 17 reais com um ngnix instalado
...
vou deixar um code-block so pra ver como ficou as cores dele
```js
 // this is a command
 function myCommand() {
+  let counter = 0;
